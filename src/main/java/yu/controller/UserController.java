...
//		System.out.printf(userBO.getNickname()+userBO.getUserId()+"--------------------------");
		System.out.printf(user.toString()+"---------");
	...
	public IMoocJSONResult searchUser(String myUserId, String friendUsername) throws Exception {
		...
		if (status == SearchFriendsStatusEnum.SUCCESS.status) {
			Users user = userService.queryUserInfoByUsername(friendUsername);//添加朋友
			UsersVO userVO = new UsersVO();
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<yu.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
